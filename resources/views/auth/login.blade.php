...
<div class="grid-x" >
     <div class="cell medium-6" style=" margin: auto;  position: absolute;  top: 80; left: 0; bottom: 0; right: 0;">
        <form class="log-in-form" role="form" method="POST" action="{{ route('login') }}">
            {{csrf_field()}}
            ...
            @endcomponent
            <input name="remember" type="checkbox" {{ old('remember') ? 'checked' : '' }}> <label for="remember">Lembrar</label>
