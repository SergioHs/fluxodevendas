...
@section('content')
    <div class="grid-x" >
        <div class="cell medium-6" style=" margin: auto;  position: absolute;  top: 80; left: 0; bottom: 0; right: 0;">
            <form class="log-in-form" role="form" method="POST" action="{{ route('register') }}">
                {{csrf_field()}}
                <h4 class="text-center">Registrar usuário</h4>
                <label>Nome
                ...
                @endcomponent
                <p><input type="submit" class="button expanded" value="Registrar" /></p>
            </form>
        </div>
    </div>
